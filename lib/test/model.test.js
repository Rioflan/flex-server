...
describe('Testing models', function () {
    ...
    describe('Users collection', function () {
        ...
        it('updates many users', function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, model.addUser("AA00001", "Name", "Fname")];
                    case 1:
                        _a.sent();
        ...
        it('updates a photo', function () { return __awaiter(_this, void 0, void 0, function () {
            var imgUrl, photo;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        imgUrl = "https://mlpforums.com/uploads/monthly_10_2013/post-18536-0-17144400-1381282031.jpg";
                        cloudinary_1.default.uploader = {
                            upload: jest.fn(function () { return new Promise(function (resolve) { return resolve({ secure_url: imgUrl }); }); })
                        };
                        return [4 /*yield*/, model.updatePhoto("AA00000", imgUrl)];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, model.getUserById("AA00000").then(function (user) { return user.photo; })];
                    case 2:
                        photo = _a.sent();
                        assert_1.default.equal(photo, imgUrl);
                        return [2 /*return*/];
                }
            });
        }); });
        it('uploads a photo', function () { return __awaiter(_this, void 0, void 0, function () {
            var imgUrl, mock, mock2;
            return __generator(this, function (_a) {
                imgUrl = "https://mlpforums.com/uploads/monthly_10_2013/post-18536-0-17144400-1381282031.jpg";
                mock = jest.fn(function () { return new Promise(function (resolve) { return resolve({ secure_url: imgUrl }); }); });
                cloudinary_1.default.uploader = {
                    upload: mock
                };
                model.uploadPhoto(imgUrl);
                assert_1.default.equal(mock.mock.calls.length, 1);
                assert_1.default.equal(mock.mock.calls[0][0], "data:image/jpeg;base64," + imgUrl);
                mock2 = jest.fn(function () { return new Promise(function (_, reject) { return reject(); }); });
                cloudinary_1.default.uploader = {
                    upload: mock2
                };
                model.uploadPhoto(imgUrl);
                assert_1.default.equal(mock2.mock.calls.length, 1);
                assert_1.default.equal(mock2.mock.calls[0][0], "data:image/jpeg;base64," + imgUrl);
                return [2 /*return*/];
            });
        }); });
    ...
    describe('Places collection', function () {
        ...
        it('resets places', function () { return __awaiter(_this, void 0, void 0, function () {
            var mockB, mockA, websocket, pooledUsers;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, model.addPlace("4-V-RER11")];
                    case 1:
                        _a.sent();
                        model.updatePlace("4-V-RER11", { using: true });
                        return [4 /*yield*/, model.addPlace("4-V-RER12")];
                    case 2:
                        _a.sent();
                    ...
                    case 4:
                        ...
                        assert_1.default.equal(mockA.mock.calls[0][0], "4-V-RER11");
