...
module.exports = function (router) {
    ...
    var _a = require("ramda"), compose = _a.compose, pick = _a.pick, last = _a.last, append = _a.append, update = _a.update, findLastIndex = _a.findLastIndex, propEq = _a.propEq;
    var _b = require("./test"), encrypt = _b.encrypt, decrypt = _b.decrypt;
    ...
    function updateUser(id_user, params) {
        User.findOne({ id: id_user }, null, { sort: { _id: -1 } }, function (err, user) {
            if (err)
                RES.status(500).send(err);
                    ...
                    case 2:
                        ...
                        if (userSit === "#" || userSit === "") {
                            ...
                            updateUser(body.id_user, {
                                ...
                                historical: append({ place_id: body.id_place, begin: beginDate, end: "" }, historical),
                                name: body.name,
                                fname: body.fname
                            });
                            if (user === "#") {
                                ...
                                indexUser = findLastIndex(propEq("place_id", body.id_place))(body.historical);
                                updateUser(user, {
                                    historical: update(indexUser, {
    ...
    router
        ...
        User.findOne({ id: body.id_user }, null, { sort: { _id: -1 } }, function (err, user) {
            if (err)
