        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, model_1.getPooledUsers()];
                case 1:
                    pool = _a.sent();
                    websocket.on('connect', function (socket) {
                        ...
                        socket.on('checkPlace', function (id_user, id_place, apiUserId) {
                            id_user = test_1.encrypt(id_user, apiUserId);
                            var index = pool.indexOf(id_user);
                            if (index > -1) {
                                socket.emit('leavePlace');
                                pool.splice(index, 1);
                                model_1.updateUser(id_user, { pool: false });
