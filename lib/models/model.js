 ...
 */
exports.getUserById = function (id_user) { return user_1.default.findOne({ id: id_user }).then(function (user) { return user; }); };
/**
 ...
 */
exports.getUsers = function () { return user_1.default.find({}).then(function (users) { return users; }); };
/**
...
*/
exports.getPlaceById = function (id_place) { return place_1.default.findOne({ id: id_place }).then(function (place) { return place; }); };
/**
 ...
 */
exports.getPlaces = function () { return place_1.default.find({}).then(function (places) { return places; }); };
/**
