 ...
 */
exports.getPooledUsers = function () { return user_1.default.find({ pool: true }).then(function (pooledUsers) { return pooledUsers.map(function (pooledUser) { return pooledUser.id; }); }); };
