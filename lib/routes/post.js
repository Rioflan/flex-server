...
var post = function (router) {
    ...
    function updateUser(id_user, params) {
        user_1.default.findOne({ id: id_user }, null, { sort: { _id: -1 } }, function (err, user) {
            ...
            console.log(actual_user.historical);
            console.log(params.historical);
                ...
                switch (_a.label) {
                    ...
                    case 8:
                        ...
                        if (userSit === body.id_place) {
                            ...
                            console.log(body.id_place)
                            console.log(body)
                            console.log(body.historical)
                            console.log(ramda_1.findLastIndex(ramda_1.propEq("place_id", body.id_place))(body.historical))
