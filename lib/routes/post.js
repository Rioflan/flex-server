...
var post = function (router) {
    ...
    */
    var getPlaceById = function (id_place) { return place_1.default.findOne({ id: id_place }).then(function (place) { return place; }); };
    /**
    ...
    function whoUses(id_place) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, getPlaceById(id_place)];
                    case 1:
                        place = _a.sent();
                        if (place)
    ...
    function post(body) {
        return __awaiter(this, void 0, void 0, function () {
            var userSit, user, beginDate, userUsedName, indexUser, endDate, endDate;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 8:
                        console.log("SIT");
                        indexUser = body.historical.length - 1;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    id_place = body.id_place;
                    return [4 /*yield*/, whoUses(id_place)];
                case 1:
                    usedById = _a.sent();
                    if (!(usedById === "#" || usedById === "")) return [3 /*break*/, 3];
                    id_user = test_1.encrypt(body.id_user, req.userId);
                    return [4 /*yield*/, getUserById(id_user).then(function (user) { return user.historical; })];
                case 2:
                    historical = _a.sent();
                    beginDate = new Date(Date.now()).toLocaleString();
                    if (usedById === "#") {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, getUserById(usedById)];
                case 4:
                    user = _a.sent();
